...
Заменяйте магические числа константами и используйте перечисления для ясного и понятного кода. 

- Тестирование на ранних этапах: Начинайте тестирование как можно раньше в процессе разработки. 
